...
`,
		...
		{
			name:     "private func with comment",
			filename: "hoge.go",
			src: `package hoge
// Out of myFunc
...
`,
		...
		{
			name:     "private type struct with comment",
			filename: "hoge.go",
			src: `package hoge
// Out of myStruct
...
`,
		...
		{
			name:     "private type interface with comment",
			filename: "hoge.go",
			src: `package hoge
// Out of myInterface
...
`,
		...
		{
			name:     "private type alias with comment",
			filename: "hoge.go",
			src: `package hoge
// Out of myType
